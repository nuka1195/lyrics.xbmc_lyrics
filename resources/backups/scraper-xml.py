...
if (__name__ == "__main__"):
    ...
    print
    for key, value in scraper["scraper"].items():
    ...
    print "site={website!r: <29}success={status!r: <10}message={msg!r}".format(website=_song.website, status=_song.status, msg=_song.message)
